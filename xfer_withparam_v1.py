...
# parameter file path:
parameter_file_path = 'parameter_file.txt'
...
def transfer_with_varied_parameters(current_source_dir, current_destination_dir):
    ...
    number_of_transfers = len(parameters)
    ...
    #for i in range(steps+1):
        ...
        parallelism = parameter[0]
        concurrency = parameter[1]
        pipelining = parameter[2]
        fast = 0
...
parameters = []
with open('parameter_file.txt', 'r') as csvfile:
