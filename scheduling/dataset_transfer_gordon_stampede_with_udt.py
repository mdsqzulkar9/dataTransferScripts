...
mode = "experiment-gordon-stampede-udt"
...
if mode == "experiment-single-transfer-group-2-multiple-times-nov13th2017":
    exp_name = "exp_single_xfer_grp_2_mult"
    folder_name = 'group_2'
    number_of_variable_params = 3
    param_samples = [2, 4, 8, 16, 24, 32]
    times = 10
...
if mode == "experiment-gordon-stampede-udt":
    exp_name = "exp_single_xfer_grp_1_udt"
    folder_name = 'group_'1
    number_of_variable_params = 3
    param_samples = [2, 4, 8, 16, 24, 32]
    times = 10
    log_directory = '/home/ubuntu/logs/'   
...
# node information: 
source = 'ec2-54-164-166-39.compute-1.amazonaws.com'
destination = 'ec2-13-228-77-217.ap-southeast-1.compute.amazonaws.com'
port = 58001
...
def experiment_single_transfer_multiple_times():
